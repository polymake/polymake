...
struct has_serialized_impl : std::is_same<typename spec_object_traits< Serialized<T> >::model, is_composite> {};
...
template <typename T>
struct spec_object_traits< cons<Serialized<T>, int_constant<object_classifier::is_opaque> > > : spec_object_traits<is_not_object> {};
