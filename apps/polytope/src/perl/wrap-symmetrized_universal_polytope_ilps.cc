...
///==== Automatically generated contents follow.    Please do not delete this line. ====
   FunctionWrapper4perl( perl::Object (int, pm::Matrix<pm::Rational> const&, pm::Array<pm::Bitset> const&, pm::Rational const&, pm::Array<pm::Array<int>> const&, pm::SparseMatrix<pm::Rational, pm::NonSymmetric> const&, perl::OptionSet) ) {
