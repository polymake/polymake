...
///==== Automatically generated contents follow.    Please do not delete this line. ====
   ...
   FunctionInstance4perl(non_vertices_X_X, perl::Canned< const Matrix< QuadraticExtension< Rational > > >, perl::Canned< const Matrix< QuadraticExtension< Rational > > >);
   FunctionInstance4perl(non_vertices_X_X, perl::Canned< const SparseMatrix< Rational, NonSymmetric > >, perl::Canned< const Matrix< Rational > >);
