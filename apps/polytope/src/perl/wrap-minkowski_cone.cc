...
///==== Automatically generated contents follow.    Please do not delete this line. ====
   ...
   FunctionWrapper4perl( perl::Object (graph::Lattice<graph::lattice::BasicDecoration, graph::lattice::Sequential>, pm::graph::Graph<pm::graph::Undirected>, pm::graph::EdgeMap<pm::graph::Undirected, pm::Vector<pm::Rational> >, pm::Set<int, pm::operations::cmp>) ) {
      perl::Value arg0(stack[0]), arg1(stack[1]), arg2(stack[2]), arg3(stack[3]);
   ...
   FunctionWrapperInstance4perl( perl::Object (graph::Lattice<graph::lattice::BasicDecoration, graph::lattice::Sequential>, pm::graph::Graph<pm::graph::Undirected>, pm::graph::EdgeMap<pm::graph::Undirected, pm::Vector<pm::Rational> >, pm::Set<int, pm::operations::cmp>) );
