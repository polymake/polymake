...
///==== Automatically generated contents follow.    Please do not delete this line. ====
   ...
   OperatorInstance4perl(Binary_brk, perl::Canned< Map< Vector< Rational >, bool > >, perl::Canned< const pm::IndexedSlice<pm::masquerade<pm::ConcatRows, pm::Matrix_base<pm::Rational>&>, pm::Series<int, true>, void> >);
   FunctionInstance4perl(new, Map< Vector< Rational >, std::string >);
   OperatorInstance4perl(Binary_brk, perl::Canned< Map< Vector< Rational >, std::string > >, perl::Canned< const pm::IndexedSlice<pm::masquerade<pm::ConcatRows, pm::Matrix_base<pm::Rational> const&>, pm::Series<int, true>, void> >);
   ...
   OperatorInstance4perl(Binary_brk, perl::Canned< Map< Vector< double >, perl::Array > >, perl::Canned< const pm::IndexedSlice<pm::IndexedSlice<pm::masquerade<pm::ConcatRows, pm::Matrix_base<double> const&>, pm::Series<int, true>, void> const&, pm::Series<int, true>, void> >);
   OperatorInstance4perl(Binary_brk, perl::Canned< Map< Vector< double >, int > >, perl::Canned< const pm::IndexedSlice<pm::IndexedSlice<pm::masquerade<pm::ConcatRows, pm::Matrix_base<double> const&>, pm::Series<int, true>, void> const&, pm::Series<int, true>, void> >);
   ...
   OperatorInstance4perl(Binary_brk, perl::Canned< Map< Vector< Rational >, bool > >, perl::Canned< const pm::IndexedSlice<pm::masquerade<pm::ConcatRows, pm::Matrix_base<pm::Rational> const&>, pm::Series<int, true>, void> >);
   ...
   OperatorInstance4perl(Binary_brk, perl::Canned< Map< Vector< Rational >, std::string > >, perl::Canned< const pm::IndexedSlice<pm::IndexedSlice<pm::masquerade<pm::ConcatRows, pm::Matrix_base<pm::Rational> const&>, pm::Series<int, true>, void>, pm::Complement<pm::SingleElementSet<int>, int, pm::operations::cmp> const&, void> >);
   ...
   OperatorInstance4perl(Binary_brk, perl::Canned< Map< Vector< double >, bool > >, perl::Canned< const pm::IndexedSlice<pm::masquerade<pm::ConcatRows, pm::Matrix_base<double> const&>, pm::Series<int, true>, void> >);
   OperatorInstance4perl(Binary_brk, perl::Canned< Map< Vector< double >, bool > >, perl::Canned< const pm::IndexedSlice<pm::masquerade<pm::ConcatRows, pm::Matrix_base<double>&>, pm::Series<int, true>, void> >);
   FunctionInstance4perl(new, Map< Vector< double >, std::string >);
   OperatorInstance4perl(Binary_brk, perl::Canned< Map< Vector< double >, std::string > >, perl::Canned< const pm::IndexedSlice<pm::masquerade<pm::ConcatRows, pm::Matrix_base<double> const&>, pm::Series<int, true>, void> >);
