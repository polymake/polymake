...
///==== Automatically generated contents follow.    Please do not delete this line. ====
   ...
   FunctionInstance4perl(assoc_find_X_X, perl::Canned< const Map< Vector< double >, int > >, perl::Canned< const Vector< double > >);
   FunctionInstance4perl(assoc_find_X_X, perl::Canned< const Map< Vector< Rational >, std::string > >, perl::Canned< const pm::IndexedSlice<pm::masquerade<pm::ConcatRows, pm::Matrix_base<pm::Rational> const&>, pm::Series<int, true>, void> >);
   FunctionInstance4perl(assoc_find_X_X, perl::Canned< const NodeHashMap< Undirected, bool > >, int);
   FunctionInstance4perl(assoc_find_X_X, perl::Canned< const EdgeHashMap< Directed, bool > >, int);
   FunctionInstance4perl(assoc_find_X_X, perl::Canned< const NodeHashMap< Directed, bool > >, int);
   FunctionInstance4perl(assoc_find_X_X, perl::Canned< const Map< int, int > >, int);
   FunctionInstance4perl(assoc_find_X_X, perl::Canned< const Map< Vector< double >, std::string > >, perl::Canned< const pm::IndexedSlice<pm::masquerade<pm::ConcatRows, pm::Matrix_base<double> const&>, pm::Series<int, true>, void> >);
   FunctionInstance4perl(assoc_find_X_X, perl::Canned< const Map< Vector< Rational >, Vector< Rational > > >, perl::Canned< const pm::IndexedSlice<pm::masquerade<pm::ConcatRows, pm::Matrix_base<pm::Rational> const&>, pm::Series<int, true>, void> >);
   FunctionInstance4perl(assoc_find_X_X, perl::Canned< const Map< Vector< Rational >, Matrix< Rational > > >, perl::Canned< const pm::IndexedSlice<pm::masquerade<pm::ConcatRows, pm::Matrix_base<pm::Rational> const&>, pm::Series<int, true>, void> >);
