...
///==== Automatically generated contents follow.    Please do not delete this line. ====
   ...
   FunctionInstance4perl(minor_X8_X8_f5, perl::Canned< const Wary< Matrix< PuiseuxFraction< Min, Rational, Rational > > > >, perl::Canned< const Set< int > >, perl::Enum<pm::all_selector>);
   ...
   FunctionInstance4perl(minor_X8_X8_f5, perl::Canned< const Wary< Matrix< double > > >, perl::Enum<pm::all_selector>, perl::Canned< const pm::Complement<pm::SingleElementSet<int>, int, pm::operations::cmp> >);
   FunctionInstance4perl(minor_X8_X8_f5, perl::Canned< Wary< SparseMatrix< int, NonSymmetric > > >, perl::Enum<pm::all_selector>, perl::Canned< const pm::Complement<pm::SingleElementSet<int>, int, pm::operations::cmp> >);
   FunctionInstance4perl(minor_X8_X8_f5, perl::Canned< const Wary< IncidenceMatrix< NonSymmetric > > >, perl::Enum<pm::all_selector>, perl::Canned< const Set< int > >);
   FunctionInstance4perl(minor_X8_X8_f5, perl::Canned< const Wary< pm::RowChain<pm::Matrix<pm::Rational> const&, pm::Matrix<pm::Rational> const&> > >, perl::Canned< const Set< int > >, perl::Enum<pm::all_selector>);
