...
///==== Automatically generated contents follow.    Please do not delete this line. ====
   ...
   FunctionInstance4perl(minor_X8_X8_f5, perl::Canned< Wary< Matrix< Integer > > >, perl::Enum<pm::all_selector>, perl::Canned< const Array< int > >);
   ...
   FunctionInstance4perl(minor_X8_X8_f5, perl::Canned< const Wary< SparseMatrix< Rational, NonSymmetric > > >, perl::Canned< const Array< int > >, perl::Enum<pm::all_selector>);
   ...
   FunctionInstance4perl(minor_X8_X8_f5, perl::Canned< Wary< Matrix< int > > >, perl::Canned< const Array< int > >, perl::Enum<pm::all_selector>);
