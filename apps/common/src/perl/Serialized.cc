...
///==== Automatically generated contents follow.    Please do not delete this line. ====
   ...
   Class4perl("Polymake::common::Serialized__Ring_A_PuiseuxFraction_A_Min_I_Rational_I_Rational_Z_I_Int_Z", pm::Serialized< Ring< PuiseuxFraction< Min, Rational, Rational >, int > >);
   ...
   Class4perl("Polymake::common::Serialized__UniPolynomial_A_PuiseuxFraction_A_Min_I_Rational_I_Rational_Z_I_Rational_Z", pm::Serialized< UniPolynomial< PuiseuxFraction< Min, Rational, Rational >, Rational > >);
