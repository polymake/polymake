...
///==== Automatically generated contents follow.    Please do not delete this line. ====
   ...
   FunctionInstance4perl(new_X_X_X, Polynomial< Rational, int >, perl::Canned< const pm::MatrixMinor<pm::Matrix<int>&, pm::Array<int> const&, pm::all_selector const&> >, perl::Canned< const Array< int > >, perl::Canned< const Ring< Rational, int > >);
   ...
   FunctionInstance4perl(new_X_X_X, Polynomial< TropicalNumber< Max, Rational >, int >, perl::Canned< const Matrix< int > >, perl::Canned< const Vector< TropicalNumber< Max, Rational > > >, perl::Canned< const Ring< TropicalNumber< Max, Rational >, int > >);
   FunctionInstance4perl(new_X_X_X, Polynomial< TropicalNumber< Min, Rational >, int >, perl::Canned< const SparseMatrix< int, NonSymmetric > >, perl::Canned< const Vector< TropicalNumber< Min, Rational > > >, perl::Canned< const Ring< TropicalNumber< Min, Rational >, int > >);
   FunctionInstance4perl(new, Polynomial< TropicalNumber< Min, Rational >, int >);
   FunctionInstance4perl(new_X, Polynomial< TropicalNumber< Min, Rational >, int >, perl::Canned< const Ring< TropicalNumber< Min, Rational >, int > >);
   ...
   FunctionInstance4perl(new_X, Polynomial< TropicalNumber< Max, Rational >, int >, perl::Canned< const Ring< TropicalNumber< Max, Rational >, int > >);
   ...
   FunctionInstance4perl(new_X_X_X, Polynomial< TropicalNumber< Min, Rational >, int >, perl::Canned< const pm::ColChain<pm::SparseMatrix<int, pm::NonSymmetric> const&, pm::Matrix<int> const&> >, perl::Canned< const Vector< TropicalNumber< Min, Rational > > >, perl::Canned< const Ring< TropicalNumber< Min, Rational >, int > >);
   FunctionInstance4perl(new_X_X, Polynomial< TropicalNumber< Min, Rational >, int >, perl::Canned< const TropicalNumber< Min, Rational > >, perl::Canned< const Ring< TropicalNumber< Min, Rational >, int > >);
   FunctionInstance4perl(new_X_X, Polynomial< TropicalNumber< Max, Rational >, int >, perl::Canned< const TropicalNumber< Max, Rational > >, perl::Canned< const Ring< TropicalNumber< Max, Rational >, int > >);
   FunctionInstance4perl(new_X_X_X, Polynomial< TropicalNumber< Max, Rational >, int >, perl::Canned< const SparseMatrix< int, NonSymmetric > >, perl::Canned< const Vector< TropicalNumber< Max, Rational > > >, perl::Canned< const Ring< TropicalNumber< Max, Rational >, int > >);
   ...
   FunctionInstance4perl(new_X_X_X, Polynomial< TropicalNumber< Max, Rational >, int >, perl::Canned< const pm::ColChain<pm::SparseMatrix<int, pm::NonSymmetric> const&, pm::Matrix<int> const&> >, perl::Canned< const Vector< TropicalNumber< Max, Rational > > >, perl::Canned< const Ring< TropicalNumber< Max, Rational >, int > >);
