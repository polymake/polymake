...
#ifndef POLYMAKE_GRAPH_GRAPH_ITERATORS_H
#define POLYMAKE_GRAPH_GRAPH_ITERATORS_H
...
public:
   ...
   explicit BFSiterator(const TGraph& graph_arg)
      : base_t(graph_arg) {}

   BFSiterator(const TGraph& graph_arg, visitor_t&& visitor_arg)
      : base_t(graph_arg, std::move(visitor_arg)) {}

   BFSiterator(const TGraph& graph_arg, int start_node)
      : base_t(graph_arg)
   {
      process(start_node);
   }

   BFSiterator(const TGraph& graph_arg, visitor_t&& visitor_arg, int start_node)
      : base_t(graph_arg, std::move(visitor_arg))
   {
      process(start_node);
   }
...
public:
   ...
   explicit DFSiterator(const TGraph& graph_arg)
      : base_t(graph_arg)
      , cur(-1) {}

   DFSiterator(const TGraph& graph_arg, visitor_t&& visitor_arg)
      : base_t(graph_arg, std::move(visitor_arg))
      , cur(-1) {}

   DFSiterator(const TGraph& graph_arg, int start_node)
      : base_t(graph_arg)
      , cur(-1)
   {
      process(start_node);
   ...
   DFSiterator(const TGraph& graph_arg, visitor_t&& visitor_arg, int start_node)
      : base_t(graph_arg, std::move(visitor_arg))
      , cur(-1)
   {
      process(start_node);
...
#endif // POLYMAKE_GRAPH_GRAPH_ITERATORS_H
