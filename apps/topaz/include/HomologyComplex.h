...
public:
   ...
   typedef SparseMatrix<E> matrix;//links MatrixType::persistent_type (als rückgabewert/speichern/objekt...) rechts GenericMatrix<MatrixType2,E> und die funbktinen templatigizieren.
