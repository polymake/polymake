...
#include "polymake/common/boost_dynamic_bitset"
...
common::boost_dynamic_bitset build(const CacheType& cache, const common::boost_dynamic_bitset& s, common::boost_dynamic_bitset) 
{
   return common::boost_dynamic_bitset(cache.get_group().lex_min_representative(s.dset()));
}
