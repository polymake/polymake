...
///==== Automatically generated contents follow.    Please do not delete this line. ====
   ...
   FunctionInterface4perl( universal_polytope_T_x_X_X_x_X, T0,T1,T2,T3 ) {
      perl::Value arg0(stack[0]), arg1(stack[1]), arg2(stack[2]), arg3(stack[3]), arg4(stack[4]);
      WrapperReturn( (universal_polytope<T0>(arg0, arg1.get<T1>(), arg2.get<T2>(), arg3, arg4.get<T3>())) );
   };
   ...
   template <typename T0, typename T1, typename T2, typename T3>
   FunctionInterface4perl( simplexity_ilp_T_x_X_X_x_X_o, T0,T1,T2,T3 ) {
      perl::Value arg0(stack[0]), arg1(stack[1]), arg2(stack[2]), arg3(stack[3]), arg4(stack[4]), arg5(stack[5]);
      WrapperReturn( (simplexity_ilp<T0>(arg0, arg1.get<T1>(), arg2.get<T2>(), arg3, arg4.get<T3>(), arg5)) );
   };

   FunctionInstance4perl(simplexity_lower_bound_T_x_X_X_x_X_o, Rational, boost_dynamic_bitset, perl::Canned< const Matrix< Rational > >, perl::Canned< const Array< boost_dynamic_bitset > >, perl::Canned< const SparseMatrix< Rational, NonSymmetric > >);
   ...
   FunctionInstance4perl(universal_polytope_T_x_X_X_x_X, Rational, perl::Canned< const Matrix< Rational > >, perl::Canned< const Array< Set< int > > >, perl::Canned< const SparseMatrix< Rational, NonSymmetric > >);
