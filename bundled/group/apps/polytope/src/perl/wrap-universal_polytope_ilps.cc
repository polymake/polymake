...
///==== Automatically generated contents follow.    Please do not delete this line. ====
   ...
   FunctionInterface4perl( simplexity_ilp_T_x_X_X_x_X_o, T0,T1,T2,T3,T4 ) {
      perl::Value arg0(stack[0]), arg1(stack[1]), arg2(stack[2]), arg3(stack[3]), arg4(stack[4]), arg5(stack[5]);
      WrapperReturn( (simplexity_ilp<T0,T1>(arg0, arg1.get<T2>(), arg2.get<T3>(), arg3, arg4.get<T4>(), arg5)) );
   };
   ...
   FunctionInstance4perl(simplexity_ilp_T_x_X_X_x_X_o, Rational, Set< int >, perl::Canned< const Matrix< Rational > >, perl::Canned< const Array< Set< int > > >, perl::Canned< const SparseMatrix< Rational, NonSymmetric > >);
   ...
   FunctionInstance4perl(simplexity_ilp_T_x_X_X_x_X_o, Rational, boost_dynamic_bitset, perl::Canned< const Matrix< Rational > >, perl::Canned< const Array< boost_dynamic_bitset > >, perl::Canned< const SparseMatrix< Rational, NonSymmetric > >);
