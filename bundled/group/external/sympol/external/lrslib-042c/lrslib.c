...
long
lrs_init_quiet (FILE* in, FILE* out)       /* returns TRUE if successful, else FALSE */
{
...
/* inequality[C[i]-lastdv] is row number of the inequality with index C[i]              */
  ...
  if (nredundcol > 0)
    {
      //CHANGES Thomas Rehn 2010-05-03
